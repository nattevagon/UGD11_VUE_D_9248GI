<template>
    <v-container>
        <v-card>
            ...
            <h2 class="text-md-center">Data Layanan Kendaraan</h2>
            ...
            <v-card-text>
                <v-container>
                    <v-row>
                        ...
                        <v-col cols="12">
                            <v-select :items="types" v-model="form.type" label="Type*" required></v-select>
                        </v-col>
                        <v-col cols="12">
                        </v-col>
                    </v-row>
        ...
        return {
            ...
            methods: {
                ...
                sendData() {
                    ...
                    this.service.append('created_at',this.date);
                    var uri=this.$apiUrl + '/service'
                    this.load=true 
